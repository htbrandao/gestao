...
- **Práticas de Gerenciamento**: Gerais _vs._ Serviços _vs._ Técnico. Ao todo são 34 práticas no ITIL 4, dentre elas:
    ...
    - Serviços: (5) Disponibilidade; (6) Capacidade e Desempenho; (7) Continuidade de Serviço; (8) Ativos de TI; (9) Configuração de Serviço; (10) Habilitação de Mudança; (11) Evento e Monitoração; (12) Incidentes; (13) Problemas; (14) Requisição de Serviço; (15) Central de Serviço; (16) Nível de Serviço; (17) Liberação
        ...
        - 14. solicitação de um usuário (ou representante) que inicia uma ação de serviço que foi acordada como parte normal da entrega; fornecer superte à qualidade acordada; requisições de serviço podem incluir solicitações para ação, pedidos de informação, pedido de fornecimento, feedback, elogios e reclamações; são parte normal de uma entrega do serviço; costumam ser pré-definidas como parte normal de uma prestação de serviços; formalização e aprovação; oportunidades de melhoria devem ser identificadas; 
        - 15. grupo de pessoas que tem como objetivo receber a demanda do cliente e dar encaminhamento; ponto único de contato (SPOC); fornecer caminho claro para o usuário efetuar os registros; time presencial, remoto, centralizado ou distribuído, processos automatizados ou robôs; canais de acesso; capacidade de escalada ("subir") horizontal e vertical
        - 16. definir metas claras de negócio para o desempenho do serviço; agrupar e analisar informações de fárias fontes (cliente, métricas operacionais, métricas de negócios); necessita engajamento para entender e confirmar as necessidades dos clientes; visão compartilhada dos serviços; garantir o atendimento aos níveis de serviços definidos; realiza revisões de serviço, capturar e relatar problemas de serviço; SLA de escrita simples e de entendimento fácil, relacionado a um serviço
        - 17. versão de serviço ou outro item de configuração que é disponibilizada para uso; disponibilizar serviços e recursos novos a alterados para uso; pode incluir muitos componentes de infraestrutura e aplicativos diferentes que trabalham coletivamente para fornecer uma funcionalidade; pode incluir documentação e treinamento; pode ser desenvolvido pelo provedor ou adquirido de terceiros; podem variar em tamanho; precede um plano de liberação (especificação dos componentes) e um cronograma de liberação para documentar o momento das liberações;  
    - Técnico: (18) Implantação
        - 18. mover hardware, software, documentação, processo ou qualquer outro componente novo ou alterado para ambientes ativos; trabalha próximo aos gerenciamentos de liberação e habilitação de mudança; provisionar := implantar; abordagem da implantação é definida pela organização (e.g.: pull, faseada, big ban, CD)
